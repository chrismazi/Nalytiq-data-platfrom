  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(buttonVariants({ variant: "ghost" }), "h-8 w-8 p-0 text-gray-500 hover:bg-gray-100 rounded-full absolute left-2 top-2 flex items-center justify-center"),
        button_next: cn(buttonVariants({ variant: "ghost" }), "h-8 w-8 p-0 text-gray-500 hover:bg-gray-100 rounded-full absolute right-2 top-2 flex items-center justify-center"),
        weekdays: "table-row",
